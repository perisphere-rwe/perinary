...
impacts the order in which variables will appear after calling
`index_terms()` (more on this in the next section)
...
`broom::tidy` followed by `index_terms` to set up your data for
tabulating.
